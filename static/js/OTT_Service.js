...
{
    document.getElementById('im1').style="filter: brightness(125%);width:900px;height: 500px;margin-left: 230px;margin-top: 50px;transition: width 2s, height 2s, transform 2s;";
    ...
    i=i+1;
    if(i%2==1)
            document.getElementById('im1').style="width: 1000px;height: 500px;margin-left: 180px;margin-top: 50px;transform:perspective();"
        else
            document.getElementById('im1').style="filter: brightness(125%);width:900px;height: 500px;margin-left: 230px;margin-top: 50px;transition: width 2s, height 2s, transform 3s;";
    if (i==img.length)
